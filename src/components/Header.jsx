...
function Header() {
    return (
        <div id='main'>
            <Navbar />
            <div className='name'>
                <h1>Welcome to <span>Amplez</span> Website</h1>
                <p className='details'>Explanation about Amplez...</p>
                <div className='header-btns'>
                    ...
                    <a href='https://play.google.com/store/apps/dev?id=7258376585183782826&gl=IL' className='cv-btn1'>Our Store</a> 
                </div>
            </div>
